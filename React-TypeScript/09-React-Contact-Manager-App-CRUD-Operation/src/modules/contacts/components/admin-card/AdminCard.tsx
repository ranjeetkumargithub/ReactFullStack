...
const AdminCard:React.FC<IProps> = (props) => {
    const {imageUrl,name, email, mobile, id} = props.contact;
            ...
            <div className="card shadow-lg">
                <div className="card-body bg-light rounded-2">
                    <div className="row align-items-center">
                        ...
                        <div
                            className="col-sm-1 d-flex flex-column justify-content-center align-items-center">
                            ...
                            <button onClick={() => clickDelete(id)} className="btn btn-danger mb-1">
